...
Another knee design was examined that focused more on attempting to match the knee motion profile. Exoskeletons discussed in \autoref{sec:ExoBack} mostly use pin-type joints in their knee joints. This is in contrast to how the actual kinematics which has a variable center of rotation \cite{morrison1970mechanics} \cite{koo2008knee}.
...
\begin{table}
    ...
    \begin{tabular}{||c|c|c||}
        ...
        \hline
    \end{tabular}
    \caption{Motor/gearbox specifications and output power specifications of the proposed joint.}
