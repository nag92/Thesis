...
The motor and gearbox need to provide sufficient torque and power to drive the knee of a $100kg$ patient through gait motion. This is mass is larger than the average mass of the North American paraplegic which on average is $68.8kg$, so assuming a larger mass allows for the motor to have a factor of safety. Additionally, it is assumed that the slow-motion collision with the ground, the dynamic loads are assumed to be negligible. This equates to approximately $65W$ of power and $25Nm$ of torque at \(15^\circ/sec\). The knee is powered by a $90W$ brushless Maxon motor used with a nominal torque of $0.56Nm$ at roughly $2500rpm$  The motor is combined with a Harmonic gearbox with a $100:1$ reduction. \autoref{table:MotorGearboxSpecs} shows the gearbox and motor specifications and the joint's mechanical properties. The calculations assumed efficiency of \(90\%\) as per the manufacturer documentation. The designed knee joint can mechanically output $81W$ and $50.4Nm$ at $15^\circ/sec$.  
...
The design was validated using a motion capture system and SolidWorks motion analysis \footnote{https://www.solidworks.com/category/simulation-solutions}. The markers on the knee were aligned on the shank and thigh segments of the knee and rotated through the desired motion as shown in \autoref{fig:KneeJointTestSetup}. This allowed us to compare the theoretical trajectory to the actual trajectory. This allows for the measurement and comparison of manufacturing tolerance. \autoref{fig:KneeJointTestResults} shows the result of the study. There are some slight deviations of the actual motion compared to the desired motion. This deviation is caused by hysteria in the system. However, these movements are very slight on a scale of less than $1mm$. Which is assumed to be negligible.   
...
This knee design is easily manufactured, the common parts are made from off the shelf parts. The only customizable component is the the guide plate. Which can be 3D printed on a standard 3D printer. The path can then be fitted to the individuals anthropomorphic parameters then 3D printed without then need to understanding advanced manufacturing methods of techniques. 