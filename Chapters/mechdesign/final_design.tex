...
%     \centering
%     \includegraphics[scale=0.05]{images/mech_design/front_exo.png}
%     \caption[Front View of LARRE]{Front View of LARRE}
%     \label{fig:my_label}
%   \end{subfigure}
%   \begin{subfigure}{0.5\textwidth}
%     \centering
%     \includegraphics[scale=0.05]{images/mech_design/exo_side.png}
%     \caption[Front View of LARRE]{Front View of LARRE}
%     \label{fig:my_label}
%   \end{subfigure}
%     \caption{fja;lskdf}
...
\centering
    \begin{subfigure}[h]{0.495\textwidth}
        \includegraphics[width=\textwidth]{images/mech_design/front_exo.png}
        \caption{Front view of LARRE}
        \label{fig:LARREFRONT}
    \end{subfigure}
        \begin{subfigure}[h]{0.495\textwidth}
        \includegraphics[width=\textwidth]{images/mech_design/exo_side.png}
