...
\begin{figure}[h!]
    ...
    \caption{Exploded Hip Mechanism}{Exploded Hip Mechanism, the motor assemblies can be replaced with free joints allowing the device to be used passivly for data collection and testing. The battery box hold a battery for un-teathered walking. The support bars hold the vest used to strap in the person and the control board for the system.}
    \label{fig:hip}-
\end{figure}
