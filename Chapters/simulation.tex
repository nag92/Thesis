...
\end{enumerate}
 ...
 \begin{figure}[h!]
    \begin{subfigure}{0.5\textwidth}
        ...
        \caption{Comparing the actual joint angle vs the desired joint angles. The green line is the desired trajectory from the previous chapter, the orange line is path of the human, and the blue line the path of the exoskeleton. }
    ...
    \begin{subfigure}{0.5\textwidth}
        ...
        \caption{The toques over a gait cycle for each of the joints. The spikes in the control signal are only single points. This is potential caused by disturbances in the system and non-smooth velocity readings. }
